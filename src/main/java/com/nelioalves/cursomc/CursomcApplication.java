...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "07186871222", TipoCliente.PESSOAFISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("35565655","24545454"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Ap 203", "Jardim", "3323232", cli1, c1);
		
		Endereco e2 = new Endereco(null, "Avenida Matos", "100", "Sala 600", "Centro", "38777012", cli1, c2);
